...
function Orders(){
  ...
  return (
    <div className="w-[95vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2825] text-[white]">
      <Nav/>
      <div className="w-[100%] h-[100%] flex items-center lg:justify-start justify-center">
        ...
        <div className="lg:w-[85%] md:w-[70%] h-[100%] lg:ml-[310px] md:ml-[250px] mt-[70px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[100px]">
          <div className="w-[400px] h-[50px] text-[28px] md:text-[40px] md-[20px] text-white ">All Orders List</div>
          {
            orders.map((order,index)=>(
              ...
              <p className="text-[20px]"> ₹ {order.amount}</p>
               ...
               <select value={order.state} className="px-[5px] py-[10px] bg-slate-500 rounded-lg border-[1px] border-[#96eef3]" onChange={(e)=>statusHandler(e,order._id)}>
