    ...
    <div className="w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black">
      ...
      <div className="w-[50%] lg:w-[40%] hidden md:flex">
        <ul className="flex items-center justify-center gap-[19px] text-white">
          <li
            className="text-[15px] hover:bg-slate-500 cursor-pointer bg-[#000000c9] py-[10px] px-[29px] rounded-2xl"
            onClick={() => navigate("/")}
          >
            HOME
          </li>
      ...
      <div className="w-[30%] flex items-center justify-end gap-[20px] relative">
        ...
        <FiShoppingCart
          className="w-[35px] h-[35px] text-[#000000] cursor-pointer hidden md:block"
      ...
      <div className="w-[100vw] h-[90px] flex items-center justify-between px-[20px] text-[12px] fixed bottom-0 left-0 bg-[#191818] md:hidden">
        ...
        <button
          className="text-white flex items-center justify-center flex-col gap-[20px]"
          onClick={() => navigate("/collection")}
        >
          <BsCollectionFill className="w-[25px] h-[25px] text-white md:hidden" />
          Collection
        </button>
        ...
        <button
          ...
          onClick={() => navigate("/cart")}
        >
          <FiShoppingCart className="w-[25px] h-[25px] text-white md:hidden" />
          Cart
        </button>

        <p className="absolute w-[18px] h-[18px] flex items-center justify-center bg-white px-[5px] py-[2px] text-black font-semibold rounded-full text-[12px] top-[8px] right-[18px]">
          {getCartCount()}
        </p>
      </div>
    </div>
