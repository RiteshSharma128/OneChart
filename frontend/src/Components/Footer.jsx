  ...
  return(
    ...
    <div className="w-[100%] md:h-[30vh] h-[15vh] md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px]">
       <div className="md:w-[30%] w-[35%] h-[100%] flex items-start justify-center flex-col gap-[5px]">
        <div className="flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px]">
          <img src={Logo} alt="image" className="md:w-[40px] md:h-[40px] w-[30px] h-[30px]" />
          <p className="text-[19px] md:text-[20px] text-[black]">OnCart</p>
         </div>
         <p className="text-[15px] text-[black] hidden md:block"> one is your all-in-one online shopping destination offering top-quality products, unbeatable deals,and fast delivery — all backed by trusted service designed to make your life easier every day.</p>
         <p className="text-[15px] text-[black] flex md:hidden">Fast. Essay. Reliable. Onecart Shopping</p>
      </div>
      <div className="md:w-[25%] w-[30%] h-[100%] flex items-center justify-center   flex-col text-center">
       ...
       <div className="flex items-center justify-center gap-[5px] mt-[10px] md:mt-[40p">
          <p className="text-[19px] md:text-[20px] text-[#1e2223] font-sans">
           GET IN TOUCH</p>
         </div>
         <ul>
    ...
    <div className="w-full h-px bg-slate-400"></div>
     <div className="w-full h-[5vh] bg-[#dbfcfcec] flex items-center justify-center">
      Copyright 2025 <span className="font-medium">@onecart.com</span> — All Rights Reserved
    </div>
