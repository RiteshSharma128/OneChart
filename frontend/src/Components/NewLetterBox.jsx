  ...
  return (
    <div className="w-[100%] h-[40vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start gap-[10px] flex-col">
      ...
      <form action="" onSubmit={handleSubmit} className="w-[100%] h-[30%] md:h-[50%] flex items-center justify-center mt-[20px] gap-[20px] px-[20px]">
        ...
        />
        <button type="submit"
          className="text-[15px] md:text-[16px] px-[10px] md:px-[30px] py-[12px] md:py-[10px] bg-[#2e3030c9] text-white flex items-center justify-center gap-[20px] border border-[#80808049] rounded-lg shadow-sm shadow-black hover:bg-slate-500 cursor-pointer transition">Subscribe
        </button>
      </form>
    </div>
  );
