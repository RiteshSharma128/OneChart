 ...
 function OurPolicy(){
   return (
    ...
    <div className="h-[8%] w-[100%] text-center mt-[70px]">
      ...
      <div className="w-[360px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px]">
     ...
     <p className="font-semibold md:text-[18px] text-[12px] text-[aliceblue] text-center">Exchange Made Esay Quick,Simple,and Customer-Friendly Process.</p>
   </div>
   ...
   <div className="w-[360px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px]">
     ...
     <p className="font-semibold md:text-[18px] text-[12px] text-[aliceblue] text-center"> Shop with Confidence 7 Day Essay Return Guarantee.</p>
   </div>
      <div className="w-[360px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px]">
